...
public class BookService {
	...
	public List<BookVO> findAll() {
		...
		var books = Model_Mapper.parseListObject(repository.findAll(), BookVO.class);
		books
			.stream()
	...
	public BookVO findById(Long id) {
		...
		var vo = Model_Mapper.parseObject(entity, BookVO.class);
	...
	public BookVO create(BookVO book) {
		...
		var entity = Model_Mapper.parseObject(book, Book.class);
		var vo =  Model_Mapper.parseObject(repository.save(entity), BookVO.class);
