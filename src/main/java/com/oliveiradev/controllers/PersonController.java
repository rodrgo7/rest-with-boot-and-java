...
import com.oliveiradev.util.MediaType;
...
public class PersonController {	
	...
	public ResponseEntity<PagedModel<EntityModel<PersonVO>>> findPersonsByNames(
		...
		Pageable pageable = PageRequest.of(page, size, Sort.by(sortDirection, "firstName"));
		return ResponseEntity.ok(service.findPersonsByNames("", pageable));
	}
	...
	@CrossOrigin(origins = {"http://localhost:8080", "http://emae.com.br"})
	@PostMapping(
