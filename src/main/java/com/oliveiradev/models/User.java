package com.oliveiradev.models;
...
public class User implements UserDetails, Serializable {
    ...
    @Column(name = "account_non_loocked")
    private Boolean account_non_loocked;
    ...
    @ManyToMany(fetch = FetchType.EAGER) //FetchType.Eager > busca o usuario e junto c/ ela vem as suas permissões
    ...
    public Boolean getAccount_non_loocked() {
        return account_non_loocked;
    }

    public void setAccount_non_loocked(Boolean account_non_loocked) {
        this.account_non_loocked = account_non_loocked;
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((account_non_loocked == null) ? 0 : account_non_loocked.hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (accountNonExpired == null) {
            ...
            return false;
        if (account_non_loocked == null) {
            if (other.account_non_loocked != null)
                return false;
        } else if (!account_non_loocked.equals(other.account_non_loocked))
            return false;
